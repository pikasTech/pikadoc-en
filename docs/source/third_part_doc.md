...
### [[YouTube] PikaPython Build and Test in STM32 Clone](https://www.youtube.com/watch?v=91xyL0ryVJg) 

### [[CNX 中文站] PikaPython，可在STM32和其他低端MCU上运行的超轻量级Python引擎](https://cnx-software.cn/2022/05/23/lightweight-python-implementation/) 

### [[YouTube] Python in STM32? w806? Not so fast... - PikaPython Review](https://www.youtube.com/watch?v=FDAjtnaQG6A) 
...
### [[OpenNet] Доступен PikaPython 1.8, вариант языка Python для микроконтроллеров](https://www.opennet.ru/opennews/art.shtml?num=57208) 

### [[CNX] PikaPython – A lightweight Python implementation that runs on STM32 and other low-end MCUs](https://www.cnx-software.com/2022/05/18/pikascript-a-lightweight-python-implementation-that-runs-on-stm32-and-other-low-end-mcus/) 
