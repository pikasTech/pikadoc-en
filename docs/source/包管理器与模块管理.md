# Package manager and module management

## [**Click to download Package Manager**](https://gitee.com/Lyon1998/pikascript/attach_files/907478/download)
...
- The *.py files contained in the module folder will be automatically copied to the current folder, in order to be able to recognize the python module (python only recognizes the module files in the current folder when importing a module.)
